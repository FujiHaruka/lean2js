...
describe("the source map ties generated functions to .lean2js declarations", () => {
  ...
  it("is v3, with the embedded source matching the shipped file", () => {
    ...
    expect(map.sources).toEqual(["verified-example.lean2js"]);
    expect(map.sourcesContent[0]).toBe(read("verified-example.lean2js"));
  });
